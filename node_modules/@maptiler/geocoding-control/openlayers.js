...
function us(i, e, t) {
  ...
  const be = void 0;
  let { reverseGeocodingExcludeTypes: Oe = be } = e, { zoom: ge = g } = e, { apiUrl: ce = "https://api.maptiler.com/geocoding" } = e, { fetchParameters: J = {} } = e, { iconsBaseUrl: yi = "https://cdn.maptiler.com/maptiler-geocoding-control/v2.1.6/icons/" } = e, { adjustUrlQuery: Vt = () => {
  } } = e, { adjustUrl: Ht = () => {
  } } = e;
  function _n(L) {
    Ne.focus(L);
  ...
  async function Yt(L, { byId: ie = !1, exact: se = !1 } = {}) {
    ...
    try {
      ...
      const mt = m === f ? l : m;
      mt !== void 0 && mt > 1 && (Ie == null ? void 0 : Ie.length) !== 1 && console.warn("For reverse geocoding when limit > 1 then types must contain single value."), Q ? (mt === 1 || mt !== void 0 && (Je || (Ie == null ? void 0 : Ie.length) === 1)) && Se.set("limit", String(mt)) : l !== void 0 && Se.set("limit", String(l)), v && Se.set("key", v), Vt(Se), Ht(gt);
  ...
  return {
    ...
    setFeatures(N, C, O) {
      ...
      e: if (C) {
        ...
        if (!O && !C.geometry.type.endsWith("Point"))
          break e;
